...
func selectionSort() {
	...
	fmt.Print("Urutkan berdasarkan Ascending? (y/n): ")
	fmt.Scan(&pilih)
	...
	if pilih == "y" {
		...
		fmt.Println("\nDaftar Pekerjaan setelah diurutkan berdasarkan nama (Z-A):")
		i = 0
		for i < N {
			fmt.Printf("- %s \n", pekerjaan[i])
			i++
...
func insertionSort() {
	var N, i, j, tempGaji int
	var tempNama, pilih string
	N = 5
	...
	if pilih == "y" {
		...
		fmt.Println("\nDaftar Pekerjaan setelah diurutkan berdasarkan gaji (terrendah-tertinggi):")
		i = 0
		for i < N {
			fmt.Printf("- %s (Rp%d)\n", pekerjaan[i], gaji[i])
			i++
		...
		fmt.Println("\nDaftar Pekerjaan setelah diurutkan berdasarkan gaji (tertinggi-terrendah):")
		i = 0
		for i < N {
			fmt.Printf("- %s (Rp%d)\n", pekerjaan[i], gaji[i])
			i++
